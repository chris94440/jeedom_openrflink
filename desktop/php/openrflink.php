...
sendVarToJS('eqType', 'openrflink');
$eqLogics = eqLogic::byType('openrflink');
$state = config::byKey('include_mode', 'openrflink');
...
<div class="row row-overflow">
  ...
  <div class="col-lg-12 eqLogicThumbnailDisplay" id="listCol">
    ...
    <div class="eqLogicThumbnailContainer logoPrimary">
      ...
      <div class="cursor logoSecondary" id="bt_healthopenrflink">
    ...
    <div class="eqLogicThumbnailContainer">
      ...
      foreach ($eqLogics as $eqLogic) {
        ...
        echo "<center>";
        echo '<img src="plugins/openrflink/plugin_info/openrflink_icon.png" height="105" width="95" />';
        echo "</center>";
...
<div class="tab-content" style="height:calc(100% - 50px);overflow:auto;overflow-x: hidden;">
            ...
            <fieldset>
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  ...
                  <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom de l'équipement openrflink}}"/>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <input type="text" class="form-control eqLogicAttr" data-l1key="configuration" data-l2key="protocol" placeholder="{{Protocole openrflink}}"/>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <input type="text" class="form-control eqLogicAttr" data-l1key="configuration" data-l2key="id" placeholder="{{Id openrflink}}"/>
                </div>
              </div>
              ...
              <div class="form-group">
                <label class="col-sm-3 control-label">{{Executer la commande}}</label>
                <div class="col-sm-3">
                  <select id="sel_icon" class="form-control eqLogicAttr" data-l1key="configuration" data-l2key="cfgNbRepeat">
                    <option selected value="1">{{1 fois}}</option>
                    <option value="2">{{2 fois}}</option>
                    <option value="3">{{3 fois}}</option>
                    <option value="4">{{4 fois}}</option>
                    <option value="4">{{5 fois}}</option>
                  </select>
                </div>
              </div>
  ...
  <div role="tabpanel" class="tab-pane" id="commandtab">
        ...
        <div class="form-actions">
          <a class="btn btn-success btn-sm cmdAction" id="bt_addopenrflinkInfo"><i class="fas fa-plus-circle"></i> {{Ajouter une commande info}}</a>
          <a class="btn btn-success btn-sm cmdAction" id="bt_addopenrflinkAction"><i class="fas fa-plus-circle"></i> {{Ajouter une commande action}}</a>
        </div>
...
<?php include_file('desktop', 'openrflink', 'js', 'openrflink'); ?>
<?php include_file('core', 'plugin.template', 'js'); ?>

<script>
$( "#sel_icon" ).change(function(){
  var text = 'plugins/openrflink/plugin_info/node_' + $("#sel_icon").val() + '.png';
