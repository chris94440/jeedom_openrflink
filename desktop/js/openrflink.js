...
$('#bt_healthRflink').on('click', function () {
  ...
  $('#md_modal').load('index.php?v=d&plugin=openrflink&modal=health').dialog('open');
});
...
$('body').on('openrflink::includeDevice', function (_event,_options) {
    if (modifyWithoutSave) {
        ...
        if (_options == '') {
            ...
            window.location.href = 'index.php?v=d&p=openrflink&m=openrflink&id=' + _options;
        }
    }
});
